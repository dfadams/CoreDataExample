...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    InsurancePROMasterViewController *masterViewController = [[InsurancePROMasterViewController alloc] initWithNibName:@"InsurancePROMasterViewController" bundle:nil];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Insurance_Needs_Calculator_PRO" withExtension:@"momd"];
